...
NORMAL_CHAOS = [
    "✨ Everyone says a fun fact about themselves; if you can’t think of one, you skip your next turn.",
    "✨ Describe an object in the room without naming it; first to guess gets 1 point.",
    "✨ Make a sound effect and everyone must repeat it; worst imitation loses 1 point.",
    "✨ Tell a tiny 3-word story; funniest one wins a point.",
    "✨ The bot chooses a color; everyone points at something in that color. Slowest loses 1 point.",
    "✨ Everyone does a mini pose; best pose wins 1 point.",
    "✨ Say a compliment to the person on your right; hesitate and you lose 1 point.",
    "✨ Everyone draws something in the air with their finger; prettiest wins 1 point.",
    "✨ Whisper a word around the circle; if the last version is totally different, everyone loses 1 point.",
    "✨ The bot gives a letter; everyone says a word starting with it. If you repeat a word already said, you lose 1 point.",
    "✨ Everyone shares a tiny goal for today; the sweetest one gets 1 point.",
    "✨ Everyone mimics an emotion (joy, surprise, confusion…); best imitation wins 1 point.",
    "✨ Describe your day in exactly five words; most creative one gets 1 point.",
    "✨ Count from 1 to 20 in random order; players who say the same number lose 1 point, and anyone who stays silent loses 3 points.",
    "✨ Describe your ideal hangout with someone you care about; most heart-melting idea wins 1 point.",
    "✨ Everyone says a “green flag” they love in people; the bot picks the sweetest for 1 point.",
    "✨ Tell a chaotic but harmless icks-inspired story; driest story loses 1 point.",
    "✨ Make your best “I’m jealous but pretending I’m not” expression; the most obvious loses 1 point.",
    "✨ Build a story together, one sentence each; if you freeze, lose 1 point.",
    "✨ Everyone stands up; last one loses 1 point.",
    "✨ Put all phones in the center; first one to light up loses 1 point.",
    "✨ When the bot says “Freeze!”, anyone who moves loses 1 point.",
    "✨ Pick a word; anyone who says it in the next round loses 1 point.",
    "✨ Find something heart-shaped or cute; slowest player loses 1 point.",
    "✨ Show a dance move; the next player copies it, and so on. First to mess up loses 1 point."
]
